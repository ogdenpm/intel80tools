$       TITLE   ('INTELLEC/MDS BOOTSTRAP, VERSION 1.1, 1974')
;
...
DATE    EQU     1000H           ;CREATION DATE, 1974
;
;NOTE:
;
...
;*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
;
;       ADDRESS CONSTANTS FOR VERSION 1.1 ONLY
;       ======= ========= === ======= === ====
;
;       THE FOLLOWING FOUR ADDRESSES ARE INSERTED FOR ASSEMBLING
;       THE VERSION 1.1 BOOTSTRAP PROM CODE ONLY. THEY SPECIFY THE
